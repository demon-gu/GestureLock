        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.GestureLockViewGroup_color_finger_up:
                    ...
                    break;
                case R.styleable.GestureLockViewGroup_color_true_finger_up:
...
//                if (checkAnswer()) {
//                    mPaint.setColor(mFingerUpTrueColor);
//                    for (int i = 0; i < mGestureLockViews.length; i++) {
//                        mGestureLockViews[i].setFingerUpColor(mFingerUpTrueColor);
//                    }
//                    this.mTryTimes = this.mTryTimesTemp;
//                } else {
//                    mPaint.setColor(mFingerUpColor);
//                    for (int i = 0; i < mGestureLockViews.length; i++) {
//                        mGestureLockViews[i].setFingerUpColor(mFingerUpColor);
//                    }
//                    this.mTryTimes--;
//                }
//                mPaint.setAlpha(50);
...
//                }
                ...
                for (Integer position : mChoose) {
                    stringBuffer.append(position);
                }
                mOnGestureLockViewListener.onGesturePwdReturnStr(stringBuffer.toString());
